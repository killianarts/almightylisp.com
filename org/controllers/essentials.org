#+title: Essentials Controller
#+property: header-args:common-lisp :tangle ../../src/controllers/essentials.lisp

Controller for the "Almighty Lisp Essentials" book page, rendering the
table of contents.
...
Renders the full table of contents for the Almighty Lisp Essentials book.

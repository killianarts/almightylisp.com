(defpackage #:almightylisp/hypermedia/components
  ...
  (:export
   ...
   #:ac-hero-text
   #:ac-code))
(in-package #:almightylisp/hypermedia/components)
...
(define-component ac-meta-information (&key title description url children)
  (</>
   (<>
     ...
     (meta :property "og:image" :content (shiso:absolute-url (shiso:static "assets/images/x-posts-preview-image.png")))
...
(define-component ac-teaser-site-layout (&key title children)
  (</>
   (ac-skeleton
     :title title
